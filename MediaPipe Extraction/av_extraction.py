...
# Load the video file
video_path = r"C:\Users\prajw\OneDrive\Desktop\VSCode\Python\Summer_Internship\Dance\Ballet11.mp4"
...
with mp_pose.Pose(static_image_mode=False, min_detection_confidence=0.5) as pose:
    ...
    output_path = "Processed_videos/" + os.path.basename(video_path).replace(".mp4", "_processed.mp4")
    ...
    json_file_path = os.path.join(dataset_folder, os.path.basename(video_path).replace(".mp4", "_data.json"))
...
audio_path = "Processed_audios/" + os.path.basename(video_path).replace(".mp4", "_processed.wav")
